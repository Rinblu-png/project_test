...
export default function ProductGrid({ products, onOpenDetail, onAddToCart, onBuyNow }) {
  return (
    <div className="container my-4" style={{ minHeight: '60vh' }}>
      <div className="border-bottom border-2 border-theme pb-2 mb-4">
        <h1 className="fw-bold text-theme-dark fs-3 mb-1">สินค้าทั้งหมด (Products)</h1>
        <p className="text-theme-muted small m-0">รายการการ์ดสะสมทั้งหมดในร้าน ({products.length} รายการ)</p>
      </div>
